...
class EventErrorHandler(commands.Cog):
    ...
    async def on_slash_command_error(
        ...
        if isinstance(error, commands.CommandOnCooldown):
            ...
            perms = [f'- {perm.title().replace("_", " ").replace("Members", "")}\n' for perm in error.missing_permissions]
            embed = disnake.Embed(
            ...
            await inter.author.send(embed=embed, components = [disnake.ui.ActionRow(url_button)])
    ...
    async def on_command_error(
        ...
        if isinstance(error, commands.CommandOnCooldown):
            ...
            await ctx.author.send(embed=embed, components = [disnake.ui.ActionRow(url_button)])
